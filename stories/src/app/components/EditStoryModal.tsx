            ...
            <div>
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-[25%_72%] gap-3">
                        ...
                        <div className=""><input type="text" defaultValue={props.name} maxLength={45} id="nameInput" required className="float-right bg-[#ccc] rounded-md w-64 p-1" /></div>
                        <div className=""><label>Description: </label></div>
                        <div className=""><textarea maxLength={200} defaultValue={props.description} id="descriptionInput" className="bg-[#ccc] rounded-md w-64 float-right p-1" /></div>
                        <div className=""></div>
