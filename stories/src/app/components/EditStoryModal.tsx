            ...
            <div>
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-[32%_66%] gap-2">
                        ...
                        <div><input type="text" defaultValue={props.name} maxLength={45} id="nameInput" required className="float-right bg-gray-200 rounded-md w-64 p-1" /></div>
                        <div className="grid grid-rows-2">
                            <div><label>Description: </label></div>
                            <div className="text-xs">max characters: 200</div>
                        </div>
                        <div className=""><textarea maxLength={200} defaultValue={props.description} id="descriptionInput" className="bg-gray-200 rounded-md w-64 float-right p-1" /></div>
                        <div className=""></div>
